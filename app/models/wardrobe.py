...
from sqlalchemy import DateTime, ForeignKey, Index, Integer, JSON, String, func, Enum as SAEnum
...
item_status_enum = SAEnum(ItemStatus, name="item_status_enum")
...
class Wardrobe(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_wardrobe_items_user_category", "user_id", "category"),  # Composite index for common query pattern
    )
    ...
    title: Mapped[str] = mapped_column(String(200), nullable=False, comment="Item title/name")
    ...
    wear_count: Mapped[int] = mapped_column(
        ...
        default=0,
        nullable=False,
        comment="Number of times item has been worn"
    )
