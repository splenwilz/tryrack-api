...
from app.models import Boutique, BoutiqueLook, BoutiqueProfile, CatalogItem, CatalogReview, Task, User, Wardrobe  # Import all models here so Alembic can detect them
